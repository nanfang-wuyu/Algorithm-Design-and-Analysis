...
public class Main1_2 {
    ...
    public static void print(){
        ...
        if(vertices[target].dist == max) System.out.println(-1);
        else {

            double logPath = vertices[target].dist;
            double sub = logPath-logPrime;
            double div = Math.pow(2,sub);
            double intDiv = Math.floor(div);
            long finalPath = (long) ((div - intDiv) * prime);
